...
Files: ./hall/hall.gltf [56.54KB] > C:\Users\zatag\3d-viewer\public\VR\hall-transformed.glb [1.89MB] (-3235%)
*/
...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/VR/hall/hall-transformed.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/VR/hall/hall-transformed.glb')
