...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/VR/display_led/display_led-transformed.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/VR/display_led/display_led-transformed.glb')
